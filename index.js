...
a=(students.filter(gender=>gender.gender.toLowerCase()=='female').map(gender=>gender.name))
console.log(a)
...
//   // 2
 b=(students.filter(gender=>gender.gender.toLowerCase()=='male').map(gender=>gender.name).reduce((accum,value)=>accum+1,0))
 console.log(b)
